...
<button className="whitespace-nowrap mt-5 btn w-40 px-4 py-2 bg-gradient-to-r from-blue-400  to-green-400 text-white rounded transform transition duration-300 hover:scale-110
