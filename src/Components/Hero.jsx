...
const Hero = () => {
  ...
  return (
    <section className="mt-44 flex items-center font-sans">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mt-4 text-gray-800">
              A Passionate <br />
            ...
            <a
              ...
              className="whitespace-nowrap mt-5 btn w-40 px-4 py-2 bg-gradient-to-r from-blue-400  to-green-400 text-white rounded transform transition duration-300 hover:scale-110
 hover:from-purple-400  hover:to-cyan-400 text-center inline-block" 
            >
              Download Resume
            </a>
          </div>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
              ...
              <img
                className="relative w-full h-full object-cover rounded-full border-4 border-gray-300 shadow-2xl"
                src={img}
