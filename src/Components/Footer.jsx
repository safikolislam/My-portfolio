...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-100 mt-5 text-black py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-gray-700">
                    ...
                    <div className="mb-6 md:mb-0">
                        ...
                        <p className="text-gray-400 mb-4">
                            Passionate <strong>Frontend Developer</strong> crafting seamless and user-friendly web experiences.
                        </p>

                        {/* Social Links */}
                        <div className="flex space-x-4">
                            <a
                                href="https://github.com/safikolislam"
                                target="_blank"
                            ...
                            <a
                                href="https://www.facebook.com/md.safikol.islam.ashik"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-gray-300 hover:text-blue-400 transition-colors"
                            >
                            ...
                            <a
                                href="https://www.linkedin.com/in/md-safikol-islam/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-gray-300 hover:text-blue-400 transition-colors"
                            >
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-2">
                            Email: <a href="mailto:safikolislam72@gmail.com" className="hover:text-blue-400">safikolislam72@gmail.com</a>
                        </p>
                ...
                <div className="pt-8 text-center">
                    <p className="text-gray-500 text-sm">
                        &copy; {new Date().getFullYear()} <strong>Safikol Islam</strong>. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
